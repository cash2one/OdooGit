...
(function($) {
    ...
    $.fn.treeview = function(settings) {
        var dfop =
            {
                 ...
                 */
                cbiconpath: "/sys_audit/static/src/css/images/icons/",
				...
				/**
				* @description {Config} ltreeUpdate
				*{Boolean} if the left tree update
				*/
				ltreeUpdate : true
            };
        ...
        function buildtree(data, ht) {
            ...
            if (data && data.length > 0) {
                ...
                for (var i = 0; i < l; i++) {
					...
					//noRepeatData.splice(0,0,data[i]);
                }
				//data = noRepeatData;
				//treenodes = data;
            }
        ...
        function buildnode(nd, ht, deep, path, isend) {
			// if (!dfop.ltreeUpdate && (nd.checkstate == null || nd.checkstate == undefined || nd.checkstate == 0))
			// {
				// nd.invisible = true;
				// return;
			// }
