...
class pm_achievement_software_copyright(models.Model):
    _name = 'pm.achievement.software.copyright'
    _description = u"软件著作权表"
    ...
    name = fields.Char('软件著作权名称', size=100, required=True)
    regist_num = fields.Char('登记号', size=30, required=True)
    ...
    attachment = fields.Integer('软件著作权附件')
