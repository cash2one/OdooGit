...
class ir_actions_act_window(osv.osv):
    ...
    _columns = {
        ...
        #2015-08-07 刘洪太修改 增加action中target类型        
        'target': fields.selection([('current','Current Window'),('new','New Window'),('inline','Inline Edit'),('inlineview','Inline View'),('current_edit','Inline Edit WithButton')], 'Target Window'),
